...
class ReplaceMapStylesNightAction extends AFreeplaneAction {
	ReplaceMapStylesNightAction() {
		super("ReplaceMapStylesNightAction");
	}
	...
	public void actionPerformed(final ActionEvent event) {
        ...
        final String darkStyle = "/templates/kimim-night.mm";
