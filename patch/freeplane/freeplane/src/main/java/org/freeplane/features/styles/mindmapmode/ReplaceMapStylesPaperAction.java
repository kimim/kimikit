...
class ReplaceMapStylesPaperAction extends AFreeplaneAction {
	ReplaceMapStylesPaperAction() {
		super("ReplaceMapStylesPaperAction");
	}
	...
	public void actionPerformed(final ActionEvent event) {
        ...
        final String darkStyle = "/templates/kimim-paper.mm";
